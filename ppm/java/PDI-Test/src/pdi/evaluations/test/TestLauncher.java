...
public class TestLauncher {
	...
	public void launch() throws ClassNotFoundException, InstantiationException, IllegalAccessException{
		startEvaluations();
	}
	...
	public void startEvaluations() throws ClassNotFoundException, InstantiationException, IllegalAccessException{
		...
		for (Runner _r : runners) {
			...
			System.out.println("NAME: "+_r.getName()+", CLASS: "+_r.getClass_());
			for (Image imgFile : l) {
