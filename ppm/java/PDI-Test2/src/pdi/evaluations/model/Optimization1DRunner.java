...
public class Optimization1DRunner extends ClassicRunner{
	...
	public void execute() {
		...
		try {
			...
			SlideWindowMap swm=VolumeFeature1D.generateSlideWindowMap(m, winH, winW);
			long t2=System.currentTimeMillis();
			System.out.println("Elapsed Time [SlideWindowMap]: "+(t2-t1)+"ms.");
			
			FeatureMatrix fMatrix=VolumeFeature1D.buildFeatureVector(m, swm, strelMin, strelMax, strelShape);
