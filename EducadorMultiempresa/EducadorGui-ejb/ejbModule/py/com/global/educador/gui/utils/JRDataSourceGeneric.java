...
public class JRDataSourceGeneric implements JRDataSource {

	private transient Logger LOG = Logger
			.getLogger(JRDataSourceGeneric.class);
	Iterator<? extends EntityInterface> iter;
	private EntityInterface entity;

	public JRDataSourceGeneric() {

	}

	public<T extends EntityInterface> JRDataSourceGeneric(T entity) {
	...
	public <T extends EntityInterface>JRDataSourceGeneric(List<T> entitycollection) {
		super();
		iter = null;
	...
	public<T extends EntityInterface> JRDataSourceGeneric(Collection<T> entities) {
		super();
		iter = null;
