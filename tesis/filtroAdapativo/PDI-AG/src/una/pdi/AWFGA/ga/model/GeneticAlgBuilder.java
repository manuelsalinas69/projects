...
import org.uma.jmetal.util.evaluator.impl.SequentialSolutionListEvaluator;
	...
	public class GeneticAlgBuilder<S extends Solution<?>> {
		   ...
		   * Builder constructor
		   */
		  public GeneticAlgBuilder(Problem<S> problem,
		  ...
		  public GeneticAlgBuilder<S> setMaxEvaluations(int maxEvaluations) {
		    this.maxEvaluations = maxEvaluations;

		    return this;
		  }

		  public GeneticAlgBuilder<S> setPopulationSize(int populationSize) {
		    this.populationSize = populationSize;

		    return this;
		  }

		  public GeneticAlgBuilder<S> setSelectionOperator(SelectionOperator<List<S>, S> selectionOperator) {
		    this.selectionOperator = selectionOperator;

		    return this;
		  }

		  public GeneticAlgBuilder<S> setSolutionListEvaluator(SolutionListEvaluator<S> evaluator) {
		    this.evaluator = evaluator;

		    return this;
		  }

		  public GeneticAlgBuilder<S> setVariant(GeneticAlgorithmVariant variant) {
		  ...
		  public Algorithm<S> build() {
		    if (variant == GeneticAlgorithmVariant.GENERATIONAL) {
		      return new GenerationalGeneticAlg<S>(problem, maxEvaluations, populationSize,
